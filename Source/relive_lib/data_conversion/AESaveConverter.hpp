...
struct FlyingSligSaveState final
{
    ...
    static ::FlyingSligSaveState From(const FlyingSligSaveState& data, u32 pathOffset)
    {
        ...
        d.field_24_current_state = static_cast<eFlyingSligMotions>(data.field_24_current_state); // TODO: enum conversion
...
struct AbeSaveState final
{
    ...
    static ::AbeSaveState From(const AbeSaveState& data, u32 pathOffset)
    {
        ...
        d.mCurrentMotion = static_cast<eAbeMotions>(data.mCurrentMotion); // TODO: enum conversion
        d.mCurrentFrame = data.mCurrentFrame;
        d.mFrameChangeCounter = data.mFrameChangeCounter;
        ...
        d.mHealth = data.mHealth;
        d.mCurrentMotion2 = static_cast<eAbeMotions>(data.mCurrentMotion2); // TODO: enum conversion
