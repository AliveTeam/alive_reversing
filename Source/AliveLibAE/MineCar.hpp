...
private:
    ...
    __int16 field_1D4_previous_input; //TODO change to InputCommands::Enum type when we can drop sizeof assert
    __int16 field_1D6_continue_move_input; //TODO change to InputCommands::Enum type when we can drop sizeof assert
};
