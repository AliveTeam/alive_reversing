    ...
    else
    {
        ...
        if (!(sControlledCharacter_5C1B8C->field_114_flags.Get(e114_Bit10_Teleporting)))
        {
            ...
            if (heroState != eAbeStates::State_86_HandstoneBegin_45BD00
                ...
                && (sControlledCharacter_5C1B8C->field_4_typeId != Types::eEvilFart_45 || LOWORD(static_cast<Abe*>(sControlledCharacter_5C1B8C)->field_124_timer.mTimer) != 2) // TODO: Cast seems wrong, missing intermediate base class??
    ...
    if (sInputObject_5BD4E0.field_0_pads[sCurrentControllerIndex_5C1BBE].field_C_held & InputCommands::ePause)
    {
            ...
            && !(pControlledChar->field_114_flags.Get(Flags_114::e114_Bit10_Teleporting)))
        {
            ...
            if (heroState != eAbeStates::State_86_HandstoneBegin_45BD00
                ...
                && heroState != eAbeStates::State_82_InsideWellExpress_45CC80
                && heroState != eAbeStates::State_83_WellExpressShotOut_45CF70
                && (pControlledChar->field_4_typeId != Types::eEvilFart_45 || LOWORD(static_cast<Abe*>(pControlledChar)->field_124_timer.mTimer) != 2) // TODO: Why LOWORD only ?? TODO: Cast seems wrong, missing intermediate base class??
