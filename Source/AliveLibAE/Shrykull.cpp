...
Shrykull* Shrykull::ctor_4AEA20()
{
    ...
    BYTE** ppRes = Add_Resource_4DC130(ResourceManager::Resource_Animation, AEResourceID::kShrmorphResID);
...
{
    if (gMap_5C3030.field_0_current_level != gMap_5C3030.field_A_level || gMap_5C3030.field_22_overlayID != gMap_5C3030.GetOverlayId_480710())
    {
...
__int16 CCSTD Shrykull::CanKill_4AEC50(BaseAnimatedWithPhysicsGameObject* pObj)
{
    return 
        ...
        pObj->field_4_typeId == Types::eSecurityClaw_47 ||
