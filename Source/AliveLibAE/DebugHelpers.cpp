...
void Command_HelperUpdate()
{
    if (sHasTeleported)
    {
        ...
        sActiveHero_5C1B68->field_1AC_flags.Set(Abe::Flags_1AC::e1AC_NoFallDamage_Bit7);
...
private:
    void Init()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            {
                // 8 bit
                mAnimRes[i] = ResourceManager::GetLoadedResource_49C2A0(ResourceManager::Resource_Animation, AEResourceID::kAbeblowResID, TRUE, FALSE);
