...
static CollisionInfo ST_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 2625, 2340, 504, 0, 375, 260}};

static CollisionInfo MI_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 5625, 2340, 1080, 95, 375, 260},
    {Collisions::Factory, 0, 0, 4125, 2600, 880, 149, 375, 260},
    {Collisions::Factory, 0, 0, 4500, 1820, 672, 54, 375, 260},
    {Collisions::Factory, 0, 0, 4500, 3640, 1344, 153, 375, 260},
    {Collisions::Factory, 0, 0, 4500, 1040, 384, 50, 375, 260},
    {Collisions::Factory, 0, 0, 4875, 1820, 728, 66, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1300, 240, 54, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 1300, 360, 46, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 1560, 336, 60, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 1040, 288, 65, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 1300, 160, 15, 375, 260},
    {Collisions::Factory, 0, 0, 3750, 780, 240, 46, 375, 260}};

static CollisionInfo NE_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 1875, 1300, 200, 27, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 2080, 384, 101, 375, 260},
    {Collisions::Factory, 0, 0, 4500, 2600, 960, 37, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 2080, 320, 35, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 1820, 504, 47, 375, 260},
    {Collisions::Factory, 0, 0, 3000, 1040, 256, 21, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 780, 168, 21, 375, 260}};

static CollisionInfo PV_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 5250, 1560, 672, 126, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 260, 32, 9, 375, 260},
    {Collisions::Factory, 0, 0, 3000, 1560, 384, 50, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 1040, 160, 69, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 780, 168, 70, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 520, 80, 24, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1560, 288, 41, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 780, 96, 32, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1040, 192, 37, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 1300, 360, 61, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 520, 96, 24, 375, 260},
    {Collisions::Factory, 0, 0, 1125, 1560, 144, 48, 375, 260},
    {Collisions::Factory, 0, 0, 4500, 2600, 960, 105, 375, 260},
    {Collisions::Factory, 0, 0, 1125, 1040, 96, 28, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 1040, 128, 26, 375, 260}};

static CollisionInfo SV_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 3000, 520, 128, 32, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 1560, 192, 84, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 780, 120, 42, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 520, 96, 34, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 1300, 160, 78, 375, 260},
    {Collisions::Factory, 0, 0, 4500, 1820, 672, 93, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1300, 240, 48, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 1300, 160, 63, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1300, 240, 53, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 780, 120, 34, 375, 260},
    {Collisions::Factory, 0, 0, 750, 260, 16, 7, 375, 260},
    {Collisions::Factory, 0, 0, 750, 520, 32, 15, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 520, 80, 22, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 780, 144, 53, 375, 260}};

static CollisionInfo FD_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 3000, 1560, 384, 37, 375, 260},
    {Collisions::Factory, 0, 0, 3000, 2080, 512, 93, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 2600, 720, 110, 375, 260},
    {Collisions::Factory, 0, 0, 3750, 1820, 560, 132, 375, 260},
    {Collisions::Factory, 0, 0, 3000, 1820, 448, 93, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 520, 64, 11, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 1040, 160, 71, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 1040, 160, 40, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1300, 240, 50, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 1040, 160, 29, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 1560, 336, 105, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 780, 120, 71, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 260, 32, 85, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 780, 96, 15, 375, 260}};

static CollisionInfo BA_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 2250, 2080, 384, 103, 375, 260},
    {Collisions::Factory, 0, 0, 1125, 1040, 96, 12, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 1300, 160, 83, 375, 260},
    {Collisions::Factory, 0, 0, 1125, 780, 72, 85, 375, 260},
    {Collisions::Factory, 0, 0, 4875, 2600, 1040, 210, 375, 260},
    {Collisions::Factory, 0, 0, 4875, 2600, 1040, 210, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1040, 192, 106, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 2080, 384, 103, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 780, 144, 41, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 780, 168, 184, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1820, 336, 40, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1820, 336, 40, 375, 260},
    {Collisions::Factory, 0, 0, 750, 780, 48, 12, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1820, 336, 184, 375, 260},
    {Collisions::Factory, 0, 0, 750, 780, 48, 16, 375, 260},
    {Collisions::Factory, 0, 0, 750, 260, 16, 7, 375, 260}};

static CollisionInfo BW_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 3750, 1820, 560, 63, 375, 260},
    {Collisions::Factory, 0, 0, 3750, 2080, 640, 126, 375, 260},
    {Collisions::Factory, 0, 0, 3750, 1300, 400, 121, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 2080, 576, 106, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 2080, 576, 106, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 2080, 576, 106, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 1560, 432, 54, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 1560, 432, 54, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 1040, 224, 57, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 1560, 432, 54, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 520, 80, 11, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 520, 64, 9, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 520, 64, 27, 375, 260},
    {Collisions::Factory, 0, 0, 3000, 780, 192, 32, 375, 260}};

static CollisionInfo BR_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 3000, 1040, 256, 79, 375, 260},
    {Collisions::Factory, 0, 0, 4500, 1820, 672, 92, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 1040, 288, 74, 375, 260},
    {Collisions::Factory, 0, 0, 3750, 1820, 560, 41, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 1300, 360, 42, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 1820, 392, 108, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 780, 144, 60, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 520, 112, 37, 375, 260},
    {Collisions::Factory, 0, 0, 3000, 1820, 448, 134, 375, 260},
    {Collisions::Factory, 0, 0, 3750, 1820, 560, 65, 375, 260},
    {Collisions::Factory, 0, 0, 3375, 3120, 864, 75, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 780, 168, 30, 375, 260},
    {Collisions::Factory, 0, 0, 3000, 260, 64, 31, 375, 260},
    {Collisions::Factory, 0, 0, 4125, 780, 264, 48, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 780, 168, 29, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1300, 240, 26, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 2600, 480, 117, 375, 260},
    {Collisions::Factory, 0, 0, 2625, 1040, 224, 30, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1040, 192, 76, 375, 260},
    {Collisions::Factory, 0, 0, 3000, 1560, 384, 25, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 520, 64, 12, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 520, 64, 12, 375, 260},
    {Collisions::Factory, 0, 0, 1125, 1040, 96, 5, 375, 260},
    {Collisions::Factory, 0, 0, 1125, 1040, 96, 19, 375, 260},
    {Collisions::Factory, 0, 0, 1125, 1040, 96, 24, 375, 260},
    {Collisions::Factory, 0, 0, 2250, 1040, 192, 26, 375, 260},
    {Collisions::Factory, 0, 0, 3000, 2340, 576, 25, 375, 260},
    {Collisions::Factory, 0, 0, 1500, 520, 64, 16, 375, 260},
    {Collisions::Factory, 0, 0, 3000, 780, 192, 18, 375, 260}};

static CollisionInfo BM_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 2625, 2600, 560, 100, 375, 260}};

static CollisionInfo TL_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 1125, 260, 24, 20, 375, 260},
    {Collisions::Factory, 0, 0, 1875, 1820, 280, 29, 375, 260}};

static CollisionInfo CR_CollisionInfo[kMaxPaths] = {
    kNullCollisionInfo,
    {Collisions::Factory, 0, 0, 3750, 1820, 560, 0, 375, 260},
    {Collisions::Factory, 0, 0, 3750, 1300, 400, 0, 375, 260}};
...
const static PerLvlData gMovieMenuInfos_561540[28] = {
    ...
    {"Backstory", EReliveLevelIds::eMenu, 65535, 65535, 4u, 65535, 65535},
    {"Prophecy", EReliveLevelIds::eMines, 65535, 65535, 1u, 65535, 65535},
    {"Vision", EReliveLevelIds::eMines, 65535, 65535, 24u, 65535, 65535},
    {"Game Opening", EReliveLevelIds::eMines, 65535, 65535, 2u, 65535, 65535},
    {"Brew", EReliveLevelIds::eMines, 65535, 65535, 26u, 65535, 65535},
    {"Brew Transition", EReliveLevelIds::eMines, 65535, 65535, 31u, 65535, 65535},
    {"Escape", EReliveLevelIds::eMines, 65535, 65535, 25u, 65535, 65535},
    {"Reward", EReliveLevelIds::eNecrum, 65535, 65535, 22u, 65535, 65535},
    {"FeeCo", EReliveLevelIds::eFeeCoDepot, 65535, 65535, 4u, 65535, 65535},
    {"Information Booth", EReliveLevelIds::eFeeCoDepot, 65535, 65535, 3u, 65535, 65535},
    {"Train 1", EReliveLevelIds::eBarracks, 65535, 65535, 5u, 65535, 65535},
    {"Train 2", EReliveLevelIds::eBrewery, 65535, 65535, 15u, 65535, 65535},
    {"Train 3", EReliveLevelIds::eBonewerkz, 65535, 65535, 6u, 65535, 65535},
    {"Aslik Info", EReliveLevelIds::eFeeCoDepot, 65535, 65535, 2u, 65535, 65535},
    {"Aslik Explodes", EReliveLevelIds::eFeeCoDepot, 65535, 65535, 1u, 65535, 65535},
    {"Dripek Info", EReliveLevelIds::eBarracks, 65535, 65535, 4u, 65535, 65535},
    {"Dripek Explodes", EReliveLevelIds::eBarracks, 65535, 65535, 3u, 65535, 65535},
    {"Phleg Info", EReliveLevelIds::eBonewerkz, 65535, 65535, 4u, 65535, 65535},
    {"Phleg Explodes", EReliveLevelIds::eBonewerkz, 65535, 65535, 5u, 65535, 65535},
    {"Soulstorm Info", EReliveLevelIds::eBrewery, 65535, 65535, 14u, 65535, 65535},
    {"Ingredient", EReliveLevelIds::eBrewery, 65535, 65535, 16u, 65535, 65535},
    {"Conference", EReliveLevelIds::eBrewery, 65535, 65535, 13u, 65535, 65535},
    {"Happy Ending", EReliveLevelIds::eBrewery, 65535, 65535, 17u, 65535, 65535},
    {"Sad Ending", EReliveLevelIds::eBrewery, 65535, 65535, 18u, 65535, 65535},
...
const static PerLvlData gDemoData_off_5617F0[23] = {
    ...
    {"Flying Slig", EReliveLevelIds::eMines, 9, 18, 4u, 0, 0},                 // MI P9
    {"Blind Mudokons 1", EReliveLevelIds::eMines, 11, 27, 5u, 0, 0},           // MI P11
    {"Blind Mudokons 2", EReliveLevelIds::eMines, 11, 22, 3u, 0, 0},           // MI P11
    {"Minecar", EReliveLevelIds::eMines, 12, 2, 6u, 0, 0},                     // MI P12
    {"Fleeches", EReliveLevelIds::eNecrum, 7, 1, 7u, 0, 0},                    // NE P7
    {"Paramite Chase", EReliveLevelIds::eMudomoVault, 2, 13, 8u, 0, 0},        // PV P2
    {"Paramites Talk", EReliveLevelIds::eMudomoVault, 6, 8, 27u, 0, 0},        // PV P6
    {"Scrab and Fleeches", EReliveLevelIds::eMudancheeVault, 12, 2, 9u, 0, 0}, // SV P12
    {"Invisibility", EReliveLevelIds::eMudancheeVault, 13, 5, 10u, 0, 0},      // SV P13
    {"Farts-a-poppin'", EReliveLevelIds::eFeeCoDepot, 6, 3, 12u, 0, 0},        // FD P6
    {"Flying Sligs 2", EReliveLevelIds::eFeeCoDepot, 12, 1, 14u, 0, 0},        // FD P12
    {"Baggage Claim", EReliveLevelIds::eFeeCoDepot_Ender, 13, 1, 15u, 0, 0},  // FD ENDER P13
    {"Shrykull", EReliveLevelIds::eBarracks, 3, 10, 16u, 0, 0},                // BA P3
    {"Crawling Sligs", EReliveLevelIds::eBarracks, 4, 6, 17u, 0, 0},           // BA P4
    {"Slogs Attack", EReliveLevelIds::eBonewerkz, 11, 7, 18u, 0, 0},           // BW P11
    {"Glukkon", EReliveLevelIds::eBonewerkz_Ender, 13, 9, 19u, 0, 0},         // BW ENDER P13
    {"Angry Mudokons", EReliveLevelIds::eBrewery, 13, 10, 22u, 0, 0},          // BR P13
    {"Sligs", EReliveLevelIds::eBrewery, 26, 4, 23u, 0, 0},                    // BR P26
    {"Tortured Mudokons", EReliveLevelIds::eBrewery, 27, 7, 24u, 0, 0},        // BR P27
    {"Greeters Go Boom", EReliveLevelIds::eBrewery, 28, 4, 25u, 0, 0}          // BR P28
};
...
{
    return &sPathData_559660.paths[static_cast<s32>(MapWrapper::ToAE(lvlId))].field_4_pFmvArray[fmvId];
}
...
{
    return sPathData_559660.paths[static_cast<s32>(MapWrapper::ToAE(lvlId))].field_20_lvl_name_cd;
}

const char_type* Path_Get_Lvl_Name(EReliveLevelIds lvlId)
{
    return sPathData_559660.paths[static_cast<s32>(MapWrapper::ToAE(lvlId))].field_14_lvl_name;
}
...
{
    return sPathData_559660.paths[static_cast<s32>(MapWrapper::ToAE(lvlId))].field_1A_unused;
}

const char_type* Path_Get_BndName(EReliveLevelIds lvlId)
{
    return sPathData_559660.paths[static_cast<s32>(MapWrapper::ToAE(lvlId))].field_38_bnd_name;
}

SoundBlockInfo* Path_Get_MusicInfo(EReliveLevelIds lvlId)
{
    return sPathData_559660.paths[static_cast<s32>(MapWrapper::ToAE(lvlId))].field_8_pMusicInfo;
}

s16 Path_Get_Reverb(EReliveLevelIds lvlId)
{
    return sPathData_559660.paths[static_cast<s32>(MapWrapper::ToAE(lvlId))].field_10_reverb;
}

const char_type* Path_Get_BsqFileName(EReliveLevelIds lvlId)
{
    return sPathData_559660.paths[static_cast<s32>(MapWrapper::ToAE(lvlId))].field_C_bsq_file_name;
}

s16 Path_Get_BackGroundMusicId(EReliveLevelIds lvlId)
{
    return sPathData_559660.paths[static_cast<s32>(MapWrapper::ToAE(lvlId))].field_12_bg_music_id;
}
...
{
    sMudsInLevelCount_55CFAC[static_cast<u32>(MapWrapper::ToAE(lvlId))].mArray[pathId] = static_cast<s16>(count);
}

s16 Path_GetMudsInLevel(EReliveLevelIds lvlId, u32 pathId)
{
    return sMudsInLevelCount_55CFAC[static_cast<u32>(MapWrapper::ToAE(lvlId))].mArray[pathId];
}
