...
void TorturedMudokon::vUpdate_47BF80()
{
    ...
    if (field_20_animation.field_4_flags.Get(AnimFlags::eBit18_IsLastFrame))
    {
        if (field_20_animation.field_E_frame_change_counter == field_20_animation.field_10_frame_delay)
        {
            ...
            {
                Mudokon_SFX_457EC0(MudSounds::eNoSad_22, 100, Math_RandomRange_496AB0(field_240, field_240 + 100), 0);
            }
        }
    }
    ...
    if (field_20_animation.field_92_current_frame == 6 && field_20_animation.field_E_frame_change_counter == field_20_animation.field_10_frame_delay)
    {
        ...
        if (sndRnd)
        {
            if (sndRnd == 1)
            {
                Mudokon_SFX_457EC0(MudSounds::eHurt1_16, 127, Math_RandomRange_496AB0(field_240, field_240 + 100), 0);
            }
        }
        else
        {
            Mudokon_SFX_457EC0(MudSounds::eHurt2_9, 127, Math_RandomRange_496AB0(field_240, field_240 + 100), 0);
        }
    }
