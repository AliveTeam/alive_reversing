...
void TorturedMudokon::VUpdate()
{
    ...
    if (mAnim.mAnimFlags.Get(AnimFlags::eBit18_IsLastFrame))
    {
        if (mAnim.mFrameChangeCounter == mAnim.field_10_frame_delay)
        {
    ...
    if (mAnim.field_92_current_frame == 6 && mAnim.mFrameChangeCounter == mAnim.field_10_frame_delay)
    {
    ...
    if (mAnim.field_92_current_frame >= 7 && !Math_RandomRange(0, 10))
    {
