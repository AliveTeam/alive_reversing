...
void FontContext::LoadFontType(FontType resourceID)
{
    ...
    switch (resourceID)
    {
        case FontType::PauseMenu:
            field_8_atlas_array = GetGameType() == GameType::eAe ? sPauseMenuFontAtlas : AO::sPauseMenuFontAtlas;
            break;
        case FontType::LcdFont:
            field_8_atlas_array = GetGameType() == GameType::eAe ? sLcdFontAtlas : AO::sLcdFontAtlas;
            break;
        default:
