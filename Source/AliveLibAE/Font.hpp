...
struct Font_Context
{
    ...
    bool LoadFontTypeFromFile(const s8* fontPath, const s8* atlasPath, s8* pPaletteOut);
    void LoadFontTypeCustom(File_Font* fontFile, Font_AtlasEntry* fontAtlas, s8* pPaletteOut);
    bool LoadFontTypeFromOddFont(const s8* fontPath, s8* pPaletteOut);
...
public:
    ...
    EXPORT s32 DrawString_4337D0(PrimHeader** ppOt, const s8* text, s32 x, s16 y, TPageAbr abr, s32 bSemiTrans, s32 a2, Layer layer, u8 r, u8 g, u8 b, s32 polyOffset, FP scale, s32 a15, s16 colorRandomRange);
    EXPORT s32 MeasureWidth_433700(const s8* text);
    EXPORT s32 MeasureWidth_4336C0(const s8* text, FP scale);
    EXPORT s32 MeasureWidth_433630(u8 character);
    EXPORT const s8* SliceText_433BD0(const s8* text, s32 left, FP scale, s32 right);
