...
struct Font_Context
{
    ...
    bool LoadFontTypeFromOddFontMem(u8 * data, char * pPaletteOut);
};
...
namespace Alive
{
    ...
    public:
        ...
        EXPORT s32 DrawString_4337D0(PrimHeader** ppOt, const char *text, s32 x, s16 y, TPageAbr abr, s32 bSemiTrans, s32 a2, Layer layer, u8 r, u8 g, u8 b, s32 polyOffset, FP scale, s32 a15, s16 colorRandomRange);
