...
namespace Alive
{
    ...
    public:
        ...
        EXPORT int DrawString_4337D0(PrimHeader** ppOt, const char *text, int x, __int16 y, char abr, int bSemiTrans, int a2, int otLayer, BYTE r, BYTE g, BYTE b, int polyOffset, FP scale, int a15, __int16 colorRandomRange);
