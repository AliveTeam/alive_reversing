...
__int16 CC Code_Length_4C9DB0(u32 code)
{
    __int16 i = 0;
    for (i = 0; code; ++i)
    {
...
int CC Code_Convert_4C9DF0(u16 code1, u16 code2)
{
    if (code2)
    {
...
GameSpeakMatch GameSpeak::MatchBuffer_4219E0(BYTE* pBuffer, __int16 max_idx, s16 src_idx)
{
    if (src_idx == -1)
    {
