...
PatrolBrain::EState PatrolBrain::Brain_Patrol_State_1()
{
    ...
    if (!mFleech.IsScrabOrParamiteNear(ScaleToGridSize(mFleech.GetSpriteScale()) * FP_FromInteger(8)))
    {
        ...
        {
            mFleech.mNextMotion = eFleechMotions::Motion_9_Fall;
    ...
    mFleech.mNextMotion = eFleechMotions::Motion_1_WakingUp;
...
PatrolBrain::EState PatrolBrain::Brain_Patrol_State_2()
{
    ...
    {
        mFleech.mNextMotion = eFleechMotions::Motion_5_PatrolCry;
    }
    else
    {
        mFleech.mNextMotion = eFleechMotions::Motion_9_Fall;
...
PatrolBrain::EState PatrolBrain::Brain_Patrol_State_3()
{
    ...
    {
        mFleech.mNextMotion = eFleechMotions::Motion_2_Unknown;
    }
    ...
    mFleech.mNextMotion = eFleechMotions::Motion_0_Sleeping;
    return EState::eSleeping;
}

PatrolBrain::EState PatrolBrain::Brain_Patrol_State_4(BaseAliveGameObject* pTarget)
{
    ...
    if (mFleech.field_14E_ScrabParamiteEventXPos >= 0)
    {
        if ((FP_FromInteger(mFleech.field_14E_ScrabParamiteEventXPos) > mFleech.mXPos && !mFleech.GetAnimation().GetFlipX()) || (FP_FromInteger(mFleech.field_14E_ScrabParamiteEventXPos) < mFleech.mXPos && mFleech.GetAnimation().GetFlipX()))
        {
            ...
            {
                mFleech.mCurrentMotion = eFleechMotions::Motion_7_StopCrawling;
            }
            else if (mFleech.GetCurrentMotion() == eFleechMotions::Motion_3_Idle)
            {
                mFleech.mCurrentMotion = eFleechMotions::Motion_6_Knockback;
            }
        }
    ...
    if (pHoist)
    {
        if (mFleech.GetCurrentMotion() == eFleechMotions::Motion_4_Crawl)
        {
            mFleech.mNextMotion = eFleechMotions::Motion_8_StopMidCrawlCycle;
        }
        else if (mFleech.GetCurrentMotion() != eFleechMotions::Motion_3_Idle)
        {
            mFleech.mNextMotion = eFleechMotions::Motion_3_Idle;
        }
    ...
    if (mFleech.GetCurrentMotion() == eFleechMotions::Motion_3_Idle)
    {
        if (mFleech.field_14C_EventXPos >= 0)
        {
            if (mFleech.mPatrolRange > 0)
            {
                ...
                mFleech.mNextMotion = eFleechMotions::Motion_4_Crawl;
                mFleech.field_14C_EventXPos = -1;
            }
            else
            {
    ...
    if (!mFleech.mGoesToSleep || (mFleech.mCurrentAnger >= mFleech.mMaxAnger && gMap.Is_Point_In_Current_Camera(mFleech.mCurrentLevel, mFleech.mCurrentPath, mFleech.mXPos, mFleech.mYPos, 0)))
    {
        ...
        mFleech.mCurrentMotion = eFleechMotions::Motion_5_PatrolCry;
        return mBrainState;
    }
    mFleech.mCurrentAnger = 0;
    mFleech.mNextMotion = eFleechMotions::Motion_2_Unknown;
...
PatrolBrain::EState PatrolBrain::Brain_Patrol_State_8(BaseAliveGameObject* pTarget)
{
...
PatrolBrain::EState PatrolBrain::Brain_Patrol_State_9()
{
    ...
    mFleech.mNextMotion = eFleechMotions::Motion_11_RaiseHead;
...
{
    auto pObj = static_cast<BaseAliveGameObject*>(sObjectIds.Find_Impl(mFleech.mFoodObjId));
    if (pObj)
    {
    ...
    switch (mBrainState)
    {
        ...
        case EState::eBlockedByWall_4:
        {
            ...
            BaseAliveGameObject* pMudOrAbe = mFleech.FindMudOrAbe();
            if (pMudOrAbe)
            {
        ...
        case EState::eUnknown_7:
        {
            ...
            if (mFleech.GetCurrentMotion() != eFleechMotions::Motion_4_Crawl || (v70 && mFleech.VIsObjNearby(ScaleToGridSize(mFleech.GetSpriteScale()) * FP_FromInteger(5), v70)))
            {
                ...
                mFleech.mNextMotion = eFleechMotions::Motion_6_Knockback;
            }
            else
            {
                mFleech.mNextMotion = eFleechMotions::Motion_7_StopCrawling;
            }
...
ChasingAbeBrain::EState ChasingAbeBrain::Brain_ChasingAbe_State_9(BaseAliveGameObject* pObj)
{
...
ChasingAbeBrain::EState ChasingAbeBrain::Brain_ChasingAbe_State_2(BaseAliveGameObject* pObj)
{
    if (!pObj || pObj->mHealth <= FP_FromInteger(0))
    {
        return EState::eBackToPatrol_13;
...
ChasingAbeBrain::EState ChasingAbeBrain::Brain_ChasingAbe_State_0(BaseAliveGameObject* pObj)
{
    if (!pObj)
    {
        mFleech.mFoodObjId = Guid{};
...
ChasingAbeBrain::EState ChasingAbeBrain::Brain_ChasingAbe_State_1(BaseAliveGameObject* pObj)
{
    if (!pObj || pObj->mHealth <= FP_FromInteger(0))
    {
        return EState::eBackToPatrol_13;
    ...
    BaseAliveGameObject* pAbeOrMud = mFleech.FindMudOrAbe();
    if (pAbeOrMud)
    {
...
ChasingAbeBrain::EState ChasingAbeBrain::Brain_ChasingAbe_State1_Helper(BaseAliveGameObject* pObj)
{
...
void ScaredBrain::VUpdate()
{
    ...
    switch (mBrainState)
    {
        ...
        case EState::eCrawl_2:
            if (mFleech.GetCurrentMotion() == eFleechMotions::Motion_3_Idle)
            {
                mFleech.mCurrentMotion = eFleechMotions::Motion_4_Crawl;
                mBrainState = EState::eReactToDanger_1;
                return;
            }
            return;
