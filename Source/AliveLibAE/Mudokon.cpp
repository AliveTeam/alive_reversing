...
void Mudokon::CreateFromSaveState(SerializedObjectData& pBuffer)
{
    ...
    if (pMud)
    {
        ...
        pMud->GetAnimation().Set_Animation_Data(pMud->GetAnimRes(kMudMotionAnimIds[static_cast<u32>(pMud->mCurrentMotion)]));
...
void Mudokon::VUpdate()
{
    ...
    const eMudMotions oldMotion = mCurrentMotion;
...
s16 Mudokon::TurningWheelHelloOrAllYaResponse()
{
    ...
    if (SwitchStates_Get(pWheelTlv->mSwitchId))
    {
        ...
        {
            field_198_turning_wheel_timer = MakeTimer(20);
        }
    }
    ...
    field_198_turning_wheel_timer = 0;
    mStoppedAtWheel = false;
    field_194_timer = MakeTimer(45);
    return 1;
}

void Mudokon::VUpdateResBlock()
{
    GetAnimation().Set_Animation_Data(GetAnimRes(kMudMotionAnimIds[static_cast<u32>(mCurrentMotion)]));
}
    ...
    switch (mBrainSubState)
    {
        ...
        case Brain_0_GiveRings::eBrain0_PreIdle_1:
            if (static_cast<s32>(sGnFrame) >= field_194_timer && mCurrentMotion == eMudMotions::Motion_0_Idle)
            {
                if (VIsFacingMe(gAbe))
                {
                    ...
                    field_194_timer = MudResponseDelay() + MakeTimer(150);
                    return Brain_0_GiveRings::eBrain0_Idle_2;
                }
        ...
        case Brain_0_GiveRings::eBrain0_Idle_2:
            ...
            else
            {
                ...
                {
                    field_194_timer = MudResponseDelay() + MakeTimer(20);
                    if (gEventSystem->mLastEvent == GameSpeakEvents::eAbe_Hello)
                    {
...
s16 Mudokon::Brain_1_Chisel()
{
    ...
    if (field_180_emo_tbl != Mud_Emotion::eAngry_1 && !field_128_angry_timer)
    {
        ...
        {
            field_128_angry_timer = MakeTimer(20);
        }
    }
    ...
    switch (mBrainSubState)
    {
        case Brain_1_Chisle::eBrain1_StartToChisle_0:
            ...
            field_194_timer = (Math_NextRandom() % 64) + (MakeTimer(35));
        ...
        case Brain_1_Chisle::eBrain1_ChisleTheFloor_1:
        {
            ...
            else if (lastSpeak != GameSpeakEvents::eAbe_AllYa)
            {
                ignoreHellOrAllYa = true;
            }
        ...
        case Brain_1_Chisle::eBrain1_StandUp_3:
        {
            ...
            if (lastSpeak != GameSpeakEvents::eAbe_Hello)
            {
                if (lastSpeak == GameSpeakEvents::eAbe_AllYa)
                {
                    bForce = true;
                }
                else
...
s16 Mudokon::Brain_2_CrouchScrub()
{
    ...
    switch (mBrainSubState)
    {
        case Brain_2_CrouchScrub::eBrain2_StartToScrub_0:
            ...
            mNextMotion = eMudMotions::None_m1;
            field_194_timer = Math_NextRandom() % 64 + MakeTimer(15);
            field_124_laugh_and_crouch_timer = Math_NextRandom() % 64 + MakeTimer(240);
        ...
        {
            if (lastSpeak == GameSpeakEvents::eAbe_Hello || lastSpeak == GameSpeakEvents::eAbe_AllYa)
            {
                bool checkAlerted = lastSpeak == GameSpeakEvents::eAbe_Hello;
                if (lastSpeak == GameSpeakEvents::eAbe_AllYa)
                {
                    if (!sIsMudStandingUp && IAmNearestToAbe())
                    {
...
s16 Mudokon::Brain_3_TurnWheel()
{
    ...
    switch (mBrainSubState)
    {
        ...
        case Brain_3_TurnWheel::eBrain3_InterruptAction_2:
            ...
            if (static_cast<s32>(sGnFrame) <= field_194_timer || mCurrentMotion != eMudMotions::Motion_0_Idle)
            {
                if (mNextMotion != eMudMotions::None_m1 || mCurrentMotion != eMudMotions::Motion_58_TurnWheelLoop)
                {
                    return mBrainSubState;
                }
                mNextMotion = eMudMotions::Motion_0_Idle;
...
s16 Mudokon::Brain_4_ListeningToAbe()
{
    ...
    if (field_180_emo_tbl != Mud_Emotion::eAngry_1 && !field_128_angry_timer)
    {
        if (SwitchStates_Get(field_120_angry_switch_id))
        {
            field_128_angry_timer = MakeTimer(15);
        }
    }
...
s16 Mudokon::Brain_ListeningToAbe_State_4()
{
    ...
    else
    {
        ...
        {
            field_17C_stand_idle_timer = 0;
            field_124_laugh_and_crouch_timer = MakeTimer(Math_RandomRange(30, 60));
            return mBrainSubState;
        }
        else
        {
            ...
            if (++field_17C_stand_idle_timer <= 540 || field_180_emo_tbl == Mud_Emotion::eWired_6)
            {
                ...
                if ((VIsObjNearby(v48, gAbe) && !mBlind) || v44 || FindWheel(mXPos, mYPos))
                {
                    ...
                    if (field_17E_delayed_speak != MudAction::eNone_17)
                    {
                        ...
                        {
                            field_194_timer = MakeTimer(20);
                        }
                        else
                        {
                            field_194_timer = (u16) MudResponseDelay() + MakeTimer(20);
                        }
                    ...
                    if (lastSpeak_1 == GameSpeakEvents::eNone)
                    {
                        ...
                        field_194_timer = MakeTimer(Math_RandomRange(22, 30));
                        field_178_brain_sub_state2 = mBrainSubState;
                    ...
                    else
                    {
                        ...
                        switch (lastSpeak_1)
                        {
                            ...
                            case GameSpeakEvents::eAbe_AllYa:
                            {
                            ...
                            case GameSpeakEvents::eAbe_Sorry:
                                field_17C_stand_idle_timer = 0;
                                return mBrainSubState;
                            ...
                            case GameSpeakEvents::eAbe_Work:
                                if (field_180_emo_tbl == Mud_Emotion::eWired_6)
                                {
                                    return Brain_4_ListeningToAbe::eBrain4_CrazyDeny_19;
                                }
                            ...
                            case GameSpeakEvents::eAbe_StopIt:
                            {
                                s16 v18 = GetBrainSubStateResponse(MudAction::eStopIt_4);
                                field_194_timer = ((u32)(u16) MudResponseDelay() >> 1) + MakeTimer(20);
                                if (!v18)
                                {
                                    return mBrainSubState;
                                }
...
s16 Mudokon::Brain_ListeningToAbe_State_5()
{
    ...
    if (LastGameSpeak() == GameSpeakEvents::eAbe_Wait)
    {
        mFollowingAbe = false;
        mNextMotion = eMudMotions::Motion_0_Idle;
...
s16 Mudokon::Brain_ListeningToAbe_State_7()
{
    ...
    if (lastSpeak == GameSpeakEvents::eNone
        && ((lastSpeak = field_182_speak_event, lastSpeak == GameSpeakEvents::eNone)
...
s16 Mudokon::Brain_ListeningToAbe_State_12()
{
    ...
    {
        if (LastGameSpeak() == GameSpeakEvents::eAbe_StopIt)
        {
...
s16 Mudokon::Brain_ListeningToAbe_State_15()
{
    ...
    if (field_182_speak_event != GameSpeakEvents::eAbe_FollowMe)
    {
        return field_178_brain_sub_state2;
    }
...
s16 Mudokon::Brain_ListeningToAbe_State_16()
{
    ...
    if (LastGameSpeak() != GameSpeakEvents::eAbe_StopIt && field_17E_delayed_speak != MudAction::eSorry_8)
    {
        return mBrainSubState;
    }
...
s16 Mudokon::Brain_ListeningToAbe_State_18()
{
    if (field_17E_delayed_speak == MudAction::eMudDied_14 || field_17E_delayed_speak == MudAction::eMudAbuse_9)
    {
        ...
        if (field_188_pTblEntry->field_0_sound == MudSounds::eOops_14)
        {
            field_194_timer = (s16)(MakeTimer(20));
        }
        else
        {
            field_194_timer = (u16) Mudokon::MudResponseDelay() + MakeTimer(20);
        }
        field_178_brain_sub_state2 = Brain_4_ListeningToAbe::eBrain4_Idle_7;
        field_17E_delayed_speak = MudAction::eNone_17;
        if (!v18)
...
s16 Mudokon::Brain_8_AngryWorker()
{
    switch (mBrainSubState)
    {
        case Brain_8_AngryWorker::eBrain8_Inactive_0:
            ...
            {
                const GameSpeakEvents lastSpeak = LastGameSpeak();
                if (lastSpeak < GameSpeakEvents::eAbe_Hello || lastSpeak > GameSpeakEvents::eAbe_Sorry)
                {
                    return mBrainSubState;
                }
            }
...
void Mudokon::Motion_45_KnockForward()
{
    ...
    if (mNextMotion != eMudMotions::None_m1 && mHealth > FP_FromInteger(0))
    {
        mCurrentMotion = mNextMotion;
        mNextMotion = eMudMotions::None_m1;
    }
