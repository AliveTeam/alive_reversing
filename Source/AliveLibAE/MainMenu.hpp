...
{
public:
    static constexpr MainMenuFrameTable sMainMenuFrameTable_561CC8[49] = {
        {AnimId::None, 0, 0, 0, 0},
    ...
    static constexpr AnimId kMenuAnims[5] = {
...
private:
    MainMenuNextCam HandleGameSpeakInput(u32 input_held, std::function<MainMenuNextCam(InputCommands cmd)> fnOnGameSpeak);
