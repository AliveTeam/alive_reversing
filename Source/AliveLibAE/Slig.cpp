...
int CC Slig::CreateFromSaveState_4B3B50(const BYTE* pBuffer)
{
    ...
    if (!ResourceManager::GetLoadedResource_49C2A0(ResourceManager::Resource_Animation, AEResourceID::kRockShadowResID, 0, 0))
    {
    ...
    BYTE** ppRes = pSlig->ResForMotion_4B1E90(animRec.mResourceId);
