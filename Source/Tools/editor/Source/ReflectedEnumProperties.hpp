...
REFLECT_ENUM(ReliveTypes, {
    ...
    {ReliveTypes::eScrabBoundLeft, QT_TRANSLATE_NOOP("ReliveTypesEnum", "Scrab Bound Left")},
    {ReliveTypes::eScrabBoundRight, QT_TRANSLATE_NOOP("ReliveTypesEnum", "Scrab Bound Right")},
    ...
    {ReliveTypes::eSligBoundRight, QT_TRANSLATE_NOOP("ReliveTypesEnum", "Slig Bound Right")},
