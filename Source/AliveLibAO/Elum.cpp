...
void Elum::ToKnockback()
{
    ...
    Environment_SFX_42A220(13u, 95, -200, this);
}
...
void CC Elum::Sfx_416E10(unsigned __int8 soundId, BaseAliveGameObject* pObj)
{
    ...
    case 5u:
        Environment_SFX_42A220(4u, 0, 0x7FFF, 0);
        break;
...
__int16 Elum::Brain_0_WithoutAbe_416190()
{
    ...
    case 6:
    {
        ...
        if (last_event_v2 == GameSpeakEvents::eUnknown_10 && gMap_507BA8.field_0_current_level == field_B2_lvl_number && gMap_507BA8.field_2_current_path == field_B0_path_number)
        {
            if (Is_In_Current_Camera_417CC0() == CameraPos::eCamCurrent_0)
            {
                field_122 = 0;
...
void Elum::State_4_Turn_4140F0()
{
    ...
    {
        Environment_SFX_42A220(8u, 0, 0x7FFF, this);
    }
...
void Elum::State_14_Speak_414860()
{
    ...
    {
        Environment_SFX_42A220(21u, 75, 0, this);
        field_170_flags &= ~0x20u;
    }
    else
    {
...
void Elum::State_15_Speak_4148F0()
{
    if (field_10_anim.field_92_current_frame == 3 && field_170_flags & 0x20)
    {
        Environment_SFX_42A220(20u, 75, 0, this);
        field_170_flags &= ~0x20u;
    }
    else
    {
