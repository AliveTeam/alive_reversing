...
void SaveGame::sub_459970(BYTE*, int)
{
    NOT_IMPLEMENTED();
}
...
void CC SaveGame::Save_459490(SaveData* pSaveData)
{
    ...
    sub_45A2D0(pSaveData->field_0_header.field_0_frame_1_name[4] , (BYTE *) dword_4BC62C[static_cast<int>(gMap_507BA8.field_0_current_level)], 34);
    ...
    if (gMap_507BA8.field_0_current_level == LevelIds::eRuptureFarmsReturn_13)
    {
        ...
        if (path_id != -1)
        {
            ...
            pSaveData->field_0_header.field_0_frame_1_name[47] = path_id + 80;
        }
    }
    ...
    int* table = &pSaveData->field_204_zone_number;
    int counter = 0;
