...
const char* sLCDMessageTable_4C7420[90] =
{
    ...
    "                               To jump, press " kAO_Jump ".   To run and jump, press " kAO_Jump " while you run using " kAO_Run ".",
    ...
    "                               To alert a Mudokon, say hello by holding " kAO_Hello " and pressing " kAO_Jump ".   Then, talk to Mudokons by holding " kAO_Hello " or " kAO_Unknown " and pressing the " kAO_Jump ", " kAO_Action ", " kAO_Throw ", or \x0f button.   Experiment!",
    "                               Possess Sligs by chanting.   Chant by holding " kAO_Hello " and " kAO_Unknown " at the same time or pressing (0) (zero) on the keyboard.",
    "                               To help Mudokons escape from slavery in Rupture Farms, chant when you see a circle of birds.   To chant, hold " kAO_Hello " and " kAO_Unknown " at the same time or pressing (0) on the keyboard.",
    ...
    "                               Lead Mudokons to bird portals, then chant to rescue them.  Chant by holding " kAO_Hello " and " kAO_Unknown ".",
    "",
    "",
    "",
    "",
