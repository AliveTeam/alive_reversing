...
void Abe::CrouchingGameSpeak_427F90()
{
    ...
    if (sInputObject_5009E8.field_0_pads[sCurrentControllerIndex_5076B8].field_0_pressed & sInputKey_LeftGameSpeakEnabler_4C65B8)
    {
...
__int16 Abe::VTakeDamage_4214E0(BaseGameObject* pFrom)
{
    ...
    if (gAbeInvulnerableCheat_5076E4 ||
        field_2A8_flags.Get(Flags_2A8::e2A8_Bit6_bShrivel) ||
        !field_10_anim.field_4_flags.Get(AnimFlags::eBit3_Render))
    {
        return 0;
    }
    ...
    case Types::eBat_6:
        if (field_100_health > FP_FromInteger(0))
        {
            ...
            else
            {
                ...
                field_FE_next_state = eAbeStates::State_128_KnockForward_429330;
    ...
    case Types::eExplosion_74:
        if (field_10_anim.field_4_flags.Get(AnimFlags::eBit3_Render))
        {
            if (field_100_health > FP_FromInteger(0))
            {
                ...
                field_FE_next_state = eAbeStates::State_70_Knockback_428FB0;
            }
    ...
    case Types::SecurityOrb_53:
        ...
        for (int i = 0; i < field_19C_throwable_count; i++)
        {
...
void Abe::State_0_Idle_423520()
{
    ...
    if (sInputObject_5009E8.isPressed(sInputKey_Hop_4C65A0))
    {
        ...
        else if (!sInputObject_5009E8.isPressed(sInputKey_LeftGameSpeakEnabler_4C65B8 | sInputKey_RightGameSpeakEnabler_4C65DC))
        {
    ...
    if (sInputObject_5009E8.isPressed(sInputKey_FartRoll_4C65B0))
    {
        field_FC_current_motion = eAbeStates::State_21_StandToCrouch_427F40;
    }
...
void Abe::State_25_RollLoop_427BB0()
{
    ...
    field_10E_released_buttons |= sInputObject_5009E8.field_0_pads[sCurrentControllerIndex_5076B8].field_8_released;
    ...
    else
    {
        ...
        if (field_FC_current_motion == eAbeStates::State_25_RollLoop_427BB0)
        {
            ...
            {
                if (!sInputObject_5009E8.isPressed(sInputKey_Run_4C65A8)
                    || sInputObject_5009E8.isPressed(sInputKey_FartRoll_4C65B0)
                    || Is_Celling_Above()
                    || field_12C_timer + 9 >= static_cast<int>(gnFrameCount_507670))
                {
                    if (field_10E_released_buttons && sInputKey_FartRoll_4C65B0)
                    {
                        if (!Is_Celling_Above() && field_12C_timer + 9 < static_cast<int>(gnFrameCount_507670))
                        {
                            ToLeftRightMovement_422AA0();
                            field_10E_released_buttons = 0;
                        }
...
void Abe::State_33_RunJumpMid_426FA0()
{
    ...
    else
    {
        ...
        if (pHoist)
        {
            ...
            if (IsSameScaleAsHoist(pHoist, this) && (IsFacingSameDirectionAsHoist(pHoist, this)) &&
                pHoist->field_18_hoist_type != Path_Hoist::Type::eOffScreen)
            {
                checkCollision = true;
            }
        }
        ...
        if (checkCollision)
        {
                ...
                field_BC_sprite_scale != FP_FromDouble(0.5) ? 1 : 16))
            {
                field_A8_xpos = FP_FromInteger(
                    (field_F0_pTlv->field_14_bottom_right.field_0_x +
                    field_F0_pTlv->field_10_top_left.field_0_x) / 2
                );
                MapFollowMe_401D30(TRUE);
                field_AC_ypos = hitY;
                field_FC_current_motion = eAbeStates::State_68_LedgeHangWobble_428E50;
...
void Abe::State_61_Respawn_42CD20()
{
    ...
    switch (field_114_gnFrame)
    {
        ...
        case 1:
        {
            ...
            field_158_pDeathFadeout->Init_419E40(40, 0, 1, 8);
            field_158_pDeathFadeout->field_C_refCount--;
            field_158_pDeathFadeout = nullptr;
            field_FE_next_state = eAbeStates::State_0_Idle_423520;
            field_118 = gnFrameCount_507670 + 60;
...
{
    if (!sInputObject_5009E8.isPressed(sInputKey_LeftGameSpeakEnabler_4C65B8 | sInputKey_RightGameSpeakEnabler_4C65DC) || !sInputObject_5009E8.isHeld(0xF0))
    {
    ...
    else
    {
        ...
        if (sInputKey_RightGameSpeakEnabler_4C65DC & sInputObject_5009E8.field_0_pads[sCurrentControllerIndex_5076B8].field_0_pressed)
        {
...
void Abe::State_150_Chant_42FD50()
{
    ...
    switch (field_110_state.chant)
    {
        case ChantStates::eUnknown_0:
        {
            ...
            if (static_cast<int>(gnFrameCount_507670) >= field_114_gnFrame - 70)
            {
                if (pObjToPossess)
                {
                    if (!field_188_pOrbWhirlWind)
