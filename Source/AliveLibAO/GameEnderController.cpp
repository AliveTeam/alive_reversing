                ...
                if (sActiveHero_507678->mCurrentMotion != eAbeMotions::Motion_162_ToShrykull_42F410 && sActiveHero_507678->mCurrentMotion != eAbeMotions::Motion_163_ShrykullEnd_42F520)
                {
                    ...
                    else
                    {
                        if (sKilledMudokons_5076BC >= Path_BadEndingMuds(gMap.mCurrentLevel, gMap.mCurrentPath))
                        {
                            ...
                            if (!ResourceManager::GetLoadedResource(ResourceManager::Resource_Animation, AOResourceID::kAbepickAOResID, 1, 0))
                            {
                            ...
                            if (!ResourceManager::GetLoadedResource(ResourceManager::Resource_Animation, AOResourceID::kAbethrowAOResID, 1, 0))
                            {
                            ...
                            if (!ResourceManager::GetLoadedResource(ResourceManager::Resource_Animation, AOResourceID::kGrenadeAOResID, 1, 0))
                            {
                            ...
                            if (!ResourceManager::GetLoadedResource(ResourceManager::Resource_Animation, AOResourceID::kExplo2AOResID, 1, 0))
                            {
                            ...
                            if (!ResourceManager::GetLoadedResource(ResourceManager::Resource_Animation, AOResourceID::kAbeblowAOResID, 1, 0))
                            {
                            ...
                            if (!ResourceManager::GetLoadedResource(ResourceManager::Resource_Animation, AOResourceID::kMetalGibAOResID, 1, 0))
                            {
