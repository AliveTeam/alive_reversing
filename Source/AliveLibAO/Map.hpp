...
{
public:
    EXPORT void Init_443EE0(__int16 level, __int16 path, __int16 camera, __int16 screenChangeEffect, __int16 fmvBaseId, __int16 forceChange);
