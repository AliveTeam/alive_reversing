...
public:
    ...
    EXPORT virtual void VUpdate_4E4510()
    {
        ...
        case State::State_2_FlyToTarget:
            ...
            else
            {
                ...
                if (static_cast<int>(sGnFrame_5C1B84) < field_DC)
                {
                    ...
                    const FP v16 = FP_FromInteger(16 - (field_DC - sGnFrame_5C1B84 )) / FP_FromInteger(16);
        ...
        case State::State_3_SpinAtTarget:
            ...
            field_D0_ypos_mid = (field_104 *  Math_Cosine_496D60((FP_FromInteger(128) * FP_FromInteger(32  - (field_DC - sGnFrame_5C1B84)) / FP_FromInteger(32)))) + field_100;
