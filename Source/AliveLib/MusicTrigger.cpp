...
EXPORT void MusicTrigger::Init_47FFB0(__int16 type, __int16 enabledBy, __int16 delay)
{
    ...
    {
    case 0:
        field_26_music_type = 3;
        field_28_counter = 400;
        break;
    case 1:
        field_26_music_type = 10;
        field_28_counter = 30;
        break;
    case 2:
        field_26_music_type = 13;
        field_28_counter = 30;
        break;
    case 3:
        field_26_music_type = 8;
        field_24_flags |= 4;
        break;
    case 4:
        field_26_music_type = 7;
        field_24_flags |= 4;
        break;
    case 5:
        field_26_music_type = 2;
        field_28_counter = delay;
        break;
    case 6:
        field_26_music_type = 12;
        field_28_counter = 30;
        break;
    default:
        break;
...
EXPORT void MusicTrigger::vUpdate_480140()
{
    ...
    if (field_24_flags & 1)
    {
        ...
        {
            field_24_flags &= ~1;
            MusicController::sub_47FD60(field_26_music_type, this, (field_24_flags >> 2) & 1, 1);
            field_24_flags |= 2u;
    ...
    else if (field_24_flags & 2)
    {
        ...
        {
            MusicController::sub_47FD60(field_26_music_type, this, (field_24_flags >> 2) & 1, 0);
        }
        else
        {
            field_6_flags.Set(BaseGameObject::eDead_Bit3);
