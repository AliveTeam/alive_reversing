...
void LCDScreen::Render_460CB0(int ** ot)
{
    if (!word_5C1B66)
    {
        ...
        OrderingTable_Add_4F8AA0(&ot[24], &field_20_prim_clippers[0][gPsxDisplay_5C1130.field_C_buffer_index]);
        ...
        OrderingTable_Add_4F8AA0(&ot[24], &field_20_prim_clippers[1][gPsxDisplay_5C1130.field_C_buffer_index]);
