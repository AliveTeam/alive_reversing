...
{
  return (bool)(this->field_0_pads[sCurrentControllerIndex_5C1BBE].field_0_pressed & command);
}

bool InputObject::isHeld(DWORD command)
{
  return (bool)(this->field_0_pads[sCurrentControllerIndex_5C1BBE].field_C_held & command);
}
