...
void CC Init_SetTPage_4F5B60(Prim_SetTPage* pPrim, int /*notUsed1*/, int /*notUsed2*/, int tpage)
{
    ...
    pPrim->field_0_header.field_B_code = PrimTypeCodes::eSetTPage;
...
void CC Init_PrimClipper_4F5B80(Prim_PrimClipper* pPrim, const PSX_RECT* pClipRect)
{
    ...
    pPrim->field_0_header.field_4.mNormal.field_5_unknown = byte_BD146C;
    pPrim->field_0_header.field_B_code = PrimTypeCodes::ePrimClipper;
...
{
    pPrim->field_0_header.field_4.mNormal.field_5_unknown = byte_BD146C;
    pPrim->field_0_header.field_B_code = PrimTypeCodes::eScreenOffset;
...
void CC Sprt_Init_4F8910(Prim_Sprt* pPrim)
{
    ...
    pPrim->field_0_header.field_4.mNormal.field_5_unknown = byte_BD146C;
    pPrim->field_0_header.field_B_code = PrimTypeCodes::eSprt;
}
...
void PolyF3_Init(Poly_F3* pPoly)
{
    ...
    pPoly->field_0_header.field_B_code = PrimTypeCodes::ePolyF3;
}
...
void LineG2_Init(Line_G2* pLine)
{
    ...
    pLine->field_0_header.field_B_code = PrimTypeCodes::eLineG2;
}
...
void LineG4_Init(Line_G4* pLine)
{
    ...
    pLine->field_0_header.field_4.mNormal.field_5_unknown = byte_BD146C;
    pLine->field_0_header.field_B_code = PrimTypeCodes::eLineG4;
...
void CC PolyG3_Init_4F8890(Poly_G3* pPoly)
{
    ...
    pPoly->field_0_header.field_4.mNormal.field_5_unknown = byte_BD146C;
    pPoly->field_0_header.field_B_code = PrimTypeCodes::ePolyG3;
}
...
void CC PolyG4_Init_4F88B0(Poly_G4* pPoly)
{
    ...
    pPoly->field_0_header.field_4.mNormal.field_5_unknown = byte_BD146C;
    pPoly->field_0_header.field_B_code = PrimTypeCodes::ePolyG4;
}
...
void CC PolyF4_Init_4F8830(Poly_F4* pPoly)
{
    ...
    pPoly->field_0_header.field_4.mNormal.field_5_unknown = byte_BD146C;
    pPoly->field_0_header.field_B_code = PrimTypeCodes::ePolyF4;
}
...
void CC PolyFT4_Init_4F8870(Poly_FT4 *pPoly)
{
    ...
    pPoly->field_0_header.field_4.mNormal.field_5_unknown = byte_BD146C;
    pPoly->field_0_header.field_B_code = PrimTypeCodes::ePolyFT4;
}

void CC Poly_FT4_Get_Rect_409DA0(PSX_RECT* pRect, const Poly_FT4* pPoly)
{
    if ((pPoly->field_0_header.field_B_code & 0xFC) == PrimTypeCodes::ePolyFT4) // TODO: Add helper for this check, also used in DrawOTag?
    {
