    ...
    if (field_11C_alive_timer < 251 && !(field_11C_alive_timer % 50))
    {
        if (field_11C_alive_timer > 0)
        {
            if (!field_118_bBlowUp)
            {
                ...
                Abe_SFX_457EC0(sAbeSFXList_555250_Tag::eFart_7, 0, 10 * (300 - field_11C_alive_timer), this);
                field_BC_ypos += field_CC_sprite_scale * FP_FromInteger(50);
            }
        }
    }
    ...
    else if (field_124_state == 1)
    {
        if (FP_GetExponent(field_C4_velx) || FP_GetExponent(field_C8_vely))
        {
            if (!(sGnFrame_5C1B84 % 3))
            {
                ...
                Abe_SFX_457EC0(sAbeSFXList_555250_Tag::eFart_7, 50, FP_GetExponent(velocityToUse * FP_FromInteger(250)) - 2000, nullptr);
        ...
        else
        {
            ...
            {
                Abe_SFX_457EC0(sAbeSFXList_555250_Tag::eFart_7, 50, Math_RandomRange_496AB0(-1500, -2000), nullptr);
            }
        }
