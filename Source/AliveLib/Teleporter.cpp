...
void Teleporter::vUpdate_4DC400()
{
    ...
    case 1:
        ...
        /*
        charYPos = sControlledCharacter_5C1B8C->field_BC_ypos;
        if (field_34_mTlvData.field_1C_scale)
        {
            New_Particles_426C70(
                ...
                128u,
                128u);
            pParticleBurst = malloc_4954D0(0x108u);
            xy = (PSX_Point)pParticleBurst;
            not_used = 4;
            if (!pParticleBurst)
            {
                goto LABEL_54;
            }
            pChar = sControlledCharacter_5C1B8C;
            scale = 0x8000;
            ypos = sControlledCharacter_5C1B8C->field_BC_ypos - 589824;
        }
        else
        {
            New_Particles_426C70(
            ...
            pChar = sControlledCharacter_5C1B8C;
            scale = 0x10000;
            ypos = sControlledCharacter_5C1B8C->field_BC_ypos - 0x120000;
        }

        ParticleBurst::ctor_41CF50(
            pParticleBurst,
            pChar->field_B8_xpos,
            ypos,
            9u,
    ...
    LABEL_56:
        /*
        v26 = 0;
        LOWORD(sControlledCharacter_5C1B8C->field_20_animation.field_4_flags) &= 0xFFFBu;
        gMap_5C3030.field_20 = 1;
        effect = screenChangeEffect[field_34_mTlvData.field_1E_wipe];
    ...
    case 4:
        /*
        pRect = sControlledCharacter_5C1B8C->vGetBoundingRect_424FD0(&bRect, 1);
        xy = *(PSX_Point *)&pRect->x;
        wh = *(PSX_Point *)&pRect->w;
        yOff = Math_FixedPoint_Multiply_496C50(
            sControlledCharacter_5C1B8C->field_CC_sprite_scale,
            0x3C0000);
        New_Particle_426F40(
            (xy.field_0_x + wh.field_0_x) / 2 << 16,
            ((xy.field_2_y + wh.field_2_y) / 2 << 16) + yOff,
            sControlledCharacter_5C1B8C->field_CC_sprite_scale);
        if (sControlledCharacter_5C1B8C->field_CC_sprite_scale == 0x8000)
        {
            pParticleBurst2 = malloc_4954D0(0x108u);
            not_used = 1;
            if (pParticleBurst2)
            {
                ParticleBurst::ctor_41CF50(
        ...
        {
            pParticleBurst3 = malloc_4954D0(0x108u);
            if (pParticleBurst3)
            {
                ParticleBurst::ctor_41CF50(
                    pParticleBurst3,
                    sControlledCharacter_5C1B8C->field_B8_xpos,
                    sControlledCharacter_5C1B8C->field_BC_ypos - 0x120000,
                    6u,
                    0x10000,
                    3,
                    9);
