    ...
    if (field_20_next_cam_frame <= static_cast<int>(sGnFrame_5C1B84))
    {
        ...
        if (gMap_5C3030.sCurrentPathId_5C3032 == 2)
        {
            if (field_24_camera_number > 22)
            {
                ...
                gMap_5C3030.SetActiveCam_480D30(16, 1, 1, 3, 0, 0);
            }
            else
            {
                gMap_5C3030.SetActiveCam_480D30(16, 2, field_24_camera_number, 3, 0, 0);
            }
        ...
        else
        {
            ...
            {
                gMap_5C3030.SetActiveCam_480D30(0, 1, 1, 0, 0, 0);
            }
            else
            {
                gMap_5C3030.SetActiveCam_480D30(16, 1, field_24_camera_number, 3, 0, 0);
            }
            gMap_5C3030.field_CE = 1;
        }
    }
