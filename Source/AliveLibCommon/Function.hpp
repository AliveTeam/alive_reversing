...
#else
#define NOT_IMPLEMENTED() { const static auto __kAddr__ = __FUNCTION__ "\0" __FUNCDNAME__; __asm push eax __asm mov eax, __kAddr__ __asm pop eax __asm nop __asm nop __asm nop __asm nop __asm s32 3 __asm nop __asm nop __asm nop __asm nop } static bool __done__ = false; if (!__done__) { __done__ = true; LOG_WARNING("Not implemented"); }
#endif
...
#define STDLIB_FUNCTION() { const static auto __kAddr__ = __FUNCTION__ "\0" __FUNCDNAME__; if (RunningAsInjectedDll()) { __asm push eax __asm mov eax, __kAddr__ __asm pop eax __asm nop __asm nop __asm nop __asm nop __asm s32 3 __asm nop __asm nop __asm nop __asm nop } }
#endif
...
#define AE_IMPLEMENTED()  { const static auto __kAddr__ = __FUNCTION__ "\0" __FUNCDNAME__; if (RunningAsInjectedDll()) { __asm push eax __asm mov eax, __kAddr__ __asm pop eax __asm nop __asm nop __asm nop __asm nop __asm s32 3 __asm nop __asm nop __asm nop __asm nop } }
#endif
