...
// 1. Whistle - on psx it's one sample for a sequence, on pc it's full sample for each low/high whistles
// 2. Slog sleeping sounds are missing on pc, uses slig sleeping sound instead
// 3. Minor differences in Abe turning sounde
// 4. psx seems to have a couple extra general efx lick rock throws and stuff
...
const std::vector<std::vector<u32>> AO_D1SNDFX_VH = {{
    // Whistle {106, 496, 0x407f007f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x6a003a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_D2SNDFX_VH = {{
    ...
    // Whistle {97, 576, 0x407f047f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x61003a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_D2ENDER_VH = {{
    // Whistle {45, 320, 0x407f047f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x2d003a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_E1SNDFX_VH = {{
    // Whistle {84, 448, 0x407f007f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x54003a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_E2SNDFX_VH = {{
    // Whistle {75, 432, 0x407f007f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x4b003a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_F1SNDFX_VH = {{
    // Whistle {93, 416, 0x407f007f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x5d003a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_F2SNDFX_VH = {{
    ...
    // Whistle {100, 608, 0x407f047f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x64003a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_F2ENDER_VH = {{
    // Whistle {59, 352, 0x407f047f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x3b003a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_MLSNDFX_VH = {{
    ...
    // Whistle {95, 496, 0x407f047f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x5f003a, 0xc100c0, 0xc300c2},
    //         {0, 497, 0x0, 0x0, 0x0, 0xb2b10000, 0x5fc080ff, 0x3a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_OPTSNDFX_VH = {{
    ...
    // Whistle {15, 144, 0x407f007f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0xf003a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_RFSNDFX_VH = {{
    ...
    // Whistle {98, 608, 0x407f047f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x62003a, 0xc100c0, 0xc300c2},
    //         {0, 609, 0x0, 0x0, 0x0, 0xb2b10000, 0x5fc080ff, 0x3a, 0xc100c0, 0xc300c2},
...
const std::vector<std::vector<u32>> AO_RFENDER_VH = {{
    ...
    // Whistle {68, 464, 0x407f047f, 0x7f000048, 0x0, 0xb2b17f7f, 0xdfeb80ff, 0x44003a, 0xc100c0, 0xc300c2},
