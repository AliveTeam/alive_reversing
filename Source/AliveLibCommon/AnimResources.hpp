...
enum class AnimId
{
    ...
    Naked_Slig_Idle,
    Naked_Slig_UsingButton,
    Naked_Slig_WakingUp,
    Naked_Slig_Crawling,
    Naked_Slig_StartFalling,
    Naked_Slig_Falling,
    Naked_Slig_Landing,
    Naked_Slig_ToShakingToIdle,
    Naked_Slig_Speaking,
    Naked_Slig_Snoozing,
    Naked_Slig_PushingWall,
    Naked_Slig_TurnAround,
    Naked_Slig_Shaking,
    Naked_Slig_Empty,
    Naked_Slig_ShakingToIdle,
    Naked_Slig_EndCrawling,
    Naked_Slig_IdleToPushingWall,
    Naked_Slig_EndPushingWall,
