...
constexpr CombinedAnimRecord kAnimRecords[] = {
    ...
    {AnimId::Mudokon_Fall,
        { "ABEFALL.BAN", 5724, 135, 80, kAbefallResID, PalId::Default},
    ...
    {AnimId::Mudokon_LiftGrabBegin,
     ...
     {"ABELIFT.BAN", 21696, 135, 80, kAbeliftResID, PalId::Default}},
    ...
    {AnimId::Mudokon_AO_LiftUse, kNullAnimDetails, {"ABELIFT.BAN", 21644, 135, 80, kAbeliftResID, PalId::Default}},

    {AnimId::Mudokon_PoisonGasDeath,
        { "ABEGAS.BAN", 28824, 135, 80, kAbegasResID, PalId::Default},
     {"ABEGAS.BAN", 27748, 135, 80, kAbegasResID, PalId::Default}},
    {AnimId::Mudokon_Idle, 
    ...
    {AnimId::Mudokon_LeverUse,
        ...
        {"ABEPULL.BAN", 10988, 135, 80, kAbepullResID, PalId::Default}},
    ...
    {AnimId::Mudokon_CrouchTurn,
     ...
     {"ABEBSIC.BAN", 255968, 135, 80, kAbebasicResID, PalId::Default}},
    {AnimId::Mudokon_StandToCrouch,
        { "ABEBSIC.BAN", 269876, 135, 80, kAbebasicResID, PalId::Default},
     {"ABEBSIC.BAN", 255384, 135, 80, kAbebasicResID, PalId::Default}},
    ...
    {AnimId::Mudokon_Knockback,
     ...
     {"ABEKNBK.BAN", 48272, 135, 80, kAbeknbkResID, PalId::Default}},
    ...
    {AnimId::Mudokon_Chant,
     ...
     {"ABEOMM.BAN", 9516, 135, 80, kAbeommResID, PalId::Default}},
    {AnimId::Mudokon_ChantEnd,
        { "ABEOMM.BAN", 10040, 135, 80, kAbeommResID, PalId::Default},
     {"ABEOMM.BAN", 9564, 135, 80, kAbeommResID, PalId::Default}},
    {AnimId::Mudokon_ToDuck,
        { "MUDWORK.BND", 5236, 135, 80, kMudoduckResID, PalId::Default}, 
        {"MUDWORK.BND", 5096, 135, 80, kMudoduckResID, PalId::Default}},
    {AnimId::Mudokon_Duck,
        { "MUDWORK.BND", 5256, 135, 80, kMudoduckResID, PalId::Default},
     {"MUDWORK.BND", 5116, 135, 80, kMudoduckResID, PalId::Default}},
    {AnimId::Mudokon_DuckToCrouch,
        { "MUDWORK.BND", 5280, 135, 80, kMudoduckResID, PalId::Default},
     {"MUDWORK.BND", 5140, 135, 80, kMudoduckResID, PalId::Default}},
    {AnimId::Mudokon_DuckKnockback,
        { "MUDBTLNK.BAN", 5328, 135, 80, kMudbtlnkResID, PalId::Default},
     {"MUDWORK.BND", 5224, 135, 80, kMudbtlnkResID, PalId::Default}},



    // AO only start
    { AnimId::Mudokon_Sling_Idle, kNullAnimDetails, {"MUDSLING.BAN", 22636, 96, 55, kSlingmudResID_508, PalId::Default} },
    { AnimId::Mudokon_Sling_Angry, kNullAnimDetails, {"MUDSLING.BAN", 22676, 96, 55, kSlingmudResID_508, PalId::Default} },
    { AnimId::Mudokon_Sling_Speak, kNullAnimDetails, {"MUDSLING.BAN", 22744, 96, 55, kSlingmudResID_508, PalId::Default} },
    { AnimId::Mudokon_Sling_ShootStart, kNullAnimDetails, {"MUDSLING.BAN", 22700, 96, 55, kSlingmudResID_508, PalId::Default} },
    { AnimId::Mudokon_Sling_ShootEnd, kNullAnimDetails, {"MUDSLING.BAN", 22720, 96, 55, kSlingmudResID_508, PalId::Default} },
    { AnimId::Mudokon_Sling_AngryToIdle, kNullAnimDetails, {"MUDSLING.BAN", 22780, 96, 55, kSlingmudResID_508, PalId::Default} },

    {AnimId::Mudokon_StandScrubLoop, kNullAnimDetails, {"MUDCHSL.BAN", 29112, 96, 55, kMudchslResID, PalId::Default}},
    {AnimId::Mudokon_StandScrubLoopToPause, kNullAnimDetails, {"MUDCHSL.BAN", 29304, 96, 55, kMudchslResID, PalId::Default}},
    {AnimId::Mudokon_StandScrubPauseToLoop, kNullAnimDetails, {"MUDCHSL.BAN", 29324, 96, 55, kMudchslResID, PalId::Default}},
    {AnimId::Mudokon_StandScrubPause, kNullAnimDetails, {"MUDCHSL.BAN", 29336, 96, 55, kMudchslResID, PalId::Default}},
    {AnimId::Mudokon_IdleToStandScrub, kNullAnimDetails, {"MUDCHSL.BAN", 29160, 96, 55, kMudchslResID, PalId::Default}},
    {AnimId::Mudokon_StandScrubToIdle, kNullAnimDetails, {"MUDCHSL.BAN", 29232, 96, 55, kMudchslResID, PalId::Default}},

    {AnimId::Mudokon_Struggle, kNullAnimDetails, {"ABEWASP.BAN", 21496, 96, 55, kAbewaspResID, PalId::Default}},
    ...
    {AnimId::Mudokon_DunnoMid, kNullAnimDetails, {"MUDLOTUS.BND", 255688, 135, 80, kMudltusResID, PalId::Default}}, // only in AO for some reason
    {AnimId::Mudokon_AO_M_15_Null, kNullAnimDetails, {"MUDLOTUS.BND", 255776, 135, 80, kMudltusResID, PalId::Default}},

    {AnimId::Mudokon_CrouchSpeak1, kNullAnimDetails, {"MUDLOTUS.BND", 256660, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_CrouchSpeak2, kNullAnimDetails, {"MUDLOTUS.BND", 256700, 135, 80, kMudltusResID, PalId::Default}},


    // todo: different maxW/maxH for elum mount?
    {AnimId::Mudokon_ElumWalkLoop, kNullAnimDetails, {"MUDLOTUS.BND", 144920, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumIdle, kNullAnimDetails, {"MUDLOTUS.BND", 145132, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumRunSlideStop, kNullAnimDetails, {"MUDLOTUS.BND", 145736, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumRunTurn, kNullAnimDetails, {"MUDLOTUS.BND", 145804, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_AO_M_106_Null, kNullAnimDetails, {"MUDLOTUS.BND", 145000, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumHopBegin, kNullAnimDetails, {"MUDLOTUS.BND", 145104, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumHopMid, kNullAnimDetails, {"MUDLOTUS.BND", 145164, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumHopLand, kNullAnimDetails, {"MUDLOTUS.BND", 145196, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumRunJumpBegin, kNullAnimDetails, {"MUDLOTUS.BND", 145220, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumRunJumpMid, kNullAnimDetails, {"MUDLOTUS.BND", 145688, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumRunJumpLand, kNullAnimDetails, {"MUDLOTUS.BND", 145240, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumTurn, kNullAnimDetails, {"MUDLOTUS.BND", 145456, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumRunLoop, kNullAnimDetails, {"MUDLOTUS.BND", 145312, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumSpeak, kNullAnimDetails, {"MUDLOTUS.BND", 145512, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_AO_M_116_Null, kNullAnimDetails, {"MUDLOTUS.BND", 145588, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumWalkBegin, kNullAnimDetails, {"MUDLOTUS.BND", 145608, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumRunBegin, kNullAnimDetails, {"MUDLOTUS.BND", 145548, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_AO_M_119_Null, kNullAnimDetails, {"MUDLOTUS.BND", 145416, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumRunToWalk, kNullAnimDetails, {"MUDLOTUS.BND", 145436, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumMidRunToWalk, kNullAnimDetails, {"MUDLOTUS.BND", 145568, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumRunTurnToRun, kNullAnimDetails, {"MUDLOTUS.BND", 145272, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumRunTurnToWalk, kNullAnimDetails, {"MUDLOTUS.BND", 145292, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumWalkEnd, kNullAnimDetails, {"MUDLOTUS.BND", 145648, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumMidWalkEnd, kNullAnimDetails, {"MUDLOTUS.BND", 145668, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumBeesStruggling, kNullAnimDetails, {"MUDLOTUS.BND", 145860, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumMountEnd, kNullAnimDetails, {"MUDLOTUS.BND", 23568, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumUnmountBegin, kNullAnimDetails, {"MUDLOTUS.BND", 13716, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumUnmountEnd, kNullAnimDetails, {"MUDLOTUS.BND", 34676, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumMountBegin, kNullAnimDetails, {"MUDLOTUS.BND", 16256, 135, 80, kMudltusResID, PalId::Default}},
    {AnimId::Mudokon_ElumFallOffEdge, kNullAnimDetails, {"MUDLOTUS.BND", 21672, 135, 80, kMudltusResID, PalId::Default}},
    ...
    {AnimId::Paramite_GameSpeakBegin,
     ...
     {"PARAMITE.BND", 15860, 138, 49, kArjpumpResID, PalId::Default}},
    {AnimId::Paramite_PreHiss,
        { "PARAMITE.BND", 17072, 137, 65u, kArjpumpResID, PalId::Default},
     {"PARAMITE.BND", 15900, 138, 49, kArjpumpResID, PalId::Default}},
    {AnimId::Paramite_Hiss,
        { "PARAMITE.BND", 17088, 137, 65u, kArjpumpResID, PalId::Default},
     {"PARAMITE.BND", 15916, 138, 49, kArjpumpResID, PalId::Default}},
    ...
    {AnimId::Paramite_Eating,
     ...
     {"PARAMITE.BND", 14728, 138, 49, kArjeatResID, PalId::Default}},
    {AnimId::Paramite_Death,
        { "PARAMITE.BND", 8108, 137, 65u, kArjfalrkResID, PalId::Default},
     {"PARAMITE.BND", 9132, 138, 49, kArjfalrkResID, PalId::Default}},
    ...
    {AnimId::Paramite_Struggle, kNullAnimDetails, {"PARAMITE.BND", 11076, 138, 49, kArjscrchResID, PalId::Default}}, // same as Paramite_Squawk?
    {AnimId::Paramite_AO_M_7_Unknown, kNullAnimDetails, {"PARAMITE.BND", 57340, 138, 49, kArjscrchResID, PalId::Default}},
    {AnimId::Paramite_AO_M_22_Unknown, kNullAnimDetails, {"PARAMITE.BND", 10520, 138, 49, kArjscrchResID, PalId::Default}},

    // TODO: check AO ResourceID's
    {AnimId::Scrab_Idle,
        { "SCRAB.BND", 224764, 156, 69, kArsbasicResID, PalId::Default},
     {"SCRAB.BND", 168644, 168, 69, kArsbasicResID, PalId::Default}},
    {AnimId::Scrab_Walk,
        { "SCRAB.BND", 224668, 156, 69, kArsbasicResID, PalId::Default},
     {"SCRAB.BND", 168548, 168, 69, kArsbasicResID, PalId::Default}},
    {AnimId::Scrab_Run,
        { "SCRAB.BND", 224796, 156, 69, kArsbasicResID, PalId::Default},
     {"SCRAB.BND", 168676, 168, 69, kArsbasicResID, PalId::Default}},
    {AnimId::Scrab_Turn,
        { "SCRAB.BND", 224860, 156, 69, kArsbasicResID, PalId::Default},
     {"SCRAB.BND", 168740, 168, 69, kArsbasicResID, PalId::Default}},
    {AnimId::Scrab_RunToStand,
        { "SCRAB.BND", 224916, 156, 69, kArsbasicResID, PalId::Default},
     {"SCRAB.BND", 168796, 168, 69, kArsbasicResID, PalId::Default}},
    {AnimId::Scrab_HopBegin,
        { "SCRAB.BND", 224964, 156, 69, kArsbasicResID, PalId::Default},
     {"SCRAB.BND", 168844, 168, 69, kArsbasicResID, PalId::Default}},
    {AnimId::Scrab_Jump,
        { "SCRAB.BND", 224988, 156, 69, kArsbasicResID, PalId::Default},
     {"SCRAB.BND", 168868, 168, 69, kArsbasicResID, PalId::Default}}, 
    {AnimId::Scrab_Landing,
        { "SCRAB.BND", 225028, 156, 69, kArsbasicResID, PalId::Default},
     {"SCRAB.BND", 168908, 168, 69, kArsbasicResID, PalId::Default}},
    ...
    {AnimId::Scrab_StandToWalk,
     ...
     {"SCRAB.BND", 168932, 168, 69, kArsbasicResID, PalId::Default}},
    {AnimId::Scrab_StandToRun,
        { "SCRAB.BND", 225072, 156, 69, kArsbasicResID, PalId::Default},
     {"SCRAB.BND", 168952, 168, 69, kArsbasicResID, PalId::Default}},
    {AnimId::Scrab_WalkToStand,
        { "SCRAB.BND", 225092, 156, 69, kArsbasicResID, PalId::Default},
     {"SCRAB.BND", 168972, 168, 69, kArsbasicResID, PalId::Default}},
    ...
    {AnimId::Scrab_GetEaten,
     ...
     {"SCRAB.BND", 1324, 168, 69, kArsbasicResID, PalId::Default}},
    {AnimId::Scrab_Stamp,
        { "SCRAB.BND", 24480, 156, 69, kArsdanceResID, PalId::Default},
     {"SCRAB.BND", 24136, 168, 69, kArsdanceResID, PalId::Default}},
    ...
    {AnimId::Scrab_HowlBegin,
     ...
     {"SCRAB.BND", 16944, 168, 69, kArshowlResID, PalId::Default}},
    {AnimId::Scrab_HowlEnd,
        { "SCRAB.BND", 17328, 156, 69, kArshowlResID, PalId::Default},
     {"SCRAB.BND", 17012, 168, 69, kArshowlResID, PalId::Default}},
    {AnimId::Scrab_Shriek,
        { "SCRAB.BND", 11532, 156, 69, kArsroarResID, PalId::Default},
     {"SCRAB.BND", 11380, 168, 69, kArsroarResID, PalId::Default}},
    {AnimId::Scrab_ScrabBattleAnim,
        { "SCRAB.BND", 31648, 156, 69, kArswhirlResID, PalId::Default},
     {"SCRAB.BND", 30940, 168, 69, kArswhirlResID, PalId::Default}},
    ...
    {AnimId::Scrab_FeedToGulp,
     ...
     {"SCRAB.BND", 26664, 168, 69, kArschewResID, PalId::Default}},
    ...
    {AnimId::Scrab_Feed,
     ...
     {"SCRAB.BND", 19600, 168, 69, kArseatResID, PalId::Default}},
    {AnimId::Scrab_AttackLunge,
        { "SCRAB.BND", 8356, 156, 69, kArsprceResID, PalId::Default},
     {"SCRAB.BND", 8212, 168, 69, kArsprceResID, PalId::Default}},
    {AnimId::Scrab_LegKick,
        { "SCRAB.BND", 14508, 156, 69, kArsskwrResID, PalId::Default},
     {"SCRAB.BND", 14228, 168, 69, kArsskwrResID, PalId::Default}},
    {AnimId::Scrab_DeathBegin,
        { "SCRAB.BND", 15600, 156, 69, kArscrshResID, PalId::Default},
     {"SCRAB.BND", 12724, 168, 69, kArscrshResID, PalId::Default}},

    {AnimId::Scrab_AO_ToFall, kNullAnimDetails, {"SCRAB.BND", 168992, 168, 69, kArseatResID, PalId::Default}},
    {AnimId::Scrab_AO_ToFeed, kNullAnimDetails, {"SCRAB.BND", 19544, 168, 69, kArseatResID, PalId::Default}},
    {AnimId::Scrab_AO_M_19_Unused, kNullAnimDetails, {"SCRAB.BND", 11060, 168, 69, kArseatResID, PalId::Default}},
    ...
    {AnimId::Slog_MoveHeadDownwards, // fall asleep better name and still accurate?
     ...
     {"SLOG.BND", 14832, 121, 57, kDogrstnResID, PalId::Default}},
    {AnimId::Slog_WakeUp,
        { "SLOG.BND", 15132, 121, 57, kDogrstnResID, PalId::Default},
     {"SLOG.BND", 14808, 121, 57, kDogrstnResID, PalId::Default}},
    {AnimId::Slog_JumpForwards,
        { "SLOG.BND", 38904, 121, 57, kDogattkResID, PalId::Default},
     {"SLOG.BND", 37952, 121, 57, kDogattkResID, PalId::Default}},
    {AnimId::Slog_JumpUpwards,
        { "SLOG.BND", 38960, 121, 57, kDogattkResID, PalId::Default},
     {"SLOG.BND", 38008, 121, 57, kDogattkResID, PalId::Default}},
    {AnimId::Slog_Eating,
        { "SLOG.BND", 39064, 121, 57, kDogattkResID, PalId::Default},
     {"SLOG.BND", 38112, 121, 57, kDogattkResID, PalId::Default}},
    {AnimId::Slog_Dying,
        { "SLOG.BND", 12412, 121, 57, kDogknfdResID, PalId::Default},
     {"SLOG.BND", 12220, 121, 57, kDogknfdResID, PalId::Default}},
    {AnimId::Slog_Scratch,
        { "SLOG.BND", 12724, 121, 57, kDogidleResID, PalId::Default},
     {"SLOG.BND", 12412, 121, 57, kDogidleResID, PalId::Default}},
    {AnimId::Slog_Growl,
        { "SLOG.BND", 12812, 121, 57, kDogidleResID, PalId::Default},
     {"SLOG.BND", 12500, 121, 57, kDogidleResID, PalId::Default}},
    {AnimId::Slog_AO_M_12_Unknown, kNullAnimDetails, {"SLOG.BND", 94804, 121, 57, kDogbasicResID, PalId::Default}},
